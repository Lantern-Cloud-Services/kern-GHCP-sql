...
/****** Object:  Table [dbo].[tblEmployee]    Script Date: 5/26/2026 1:58:11 PM ******/
SET ANSI_NULLS ON
GO
...
/****** Object:  Table [dbo].[tblInOutStatus]    Script Date: 5/26/2026 1:58:11 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[tblInOutStatus](
	...
	[LastModifiedEmpID] [int] NULL,
	[LastModifiedDate] [datetime] NOT NULL,
 CONSTRAINT [PK_tblInOutStatus_1] PRIMARY KEY CLUSTERED 
(
	[EmployeeID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
...
ALTER TABLE [dbo].[tblInOutStatus] ADD  CONSTRAINT [DF_tblInOutStatus_InsertedDate]  DEFAULT (getdate()) FOR [InsertedDate]
GO

ALTER TABLE [dbo].[tblInOutStatus] ADD  CONSTRAINT [DF_tblInOutStatus_LastModifiedDate]  DEFAULT (getdate()) FOR [LastModifiedDate]
GO
...
ALTER TABLE [dbo].[tblInOutStatus]  WITH CHECK ADD  CONSTRAINT [FK_tblInOutStatus_tblEmployee] FOREIGN KEY([EmployeeID])
REFERENCES [dbo].[tblEmployee] ([EmployeeID])
GO

ALTER TABLE [dbo].[tblInOutStatus] CHECK CONSTRAINT [FK_tblInOutStatus_tblEmployee]
GO
